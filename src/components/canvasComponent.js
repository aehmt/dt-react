...
const CanvasComponent = (props) => {
  let rendered;
    ...
    return (
      <div id="painting">
        <canvas onMouseMove={props.onMove} id="ourCanvas" width="925" height="500" style={{backgroundColor: '#008811', borderRadius: 10, borderWidth: 0.5, borderColor: '#d6d7da', opacity: '0.75'}}>
          {rendered}
        </canvas>
      </div>
    )
